  ...
  <div class="task-form-wrapper">
    <div class="task-form-container">
      ...
      <form @submit.prevent="onSubmit" class="form-body">
        ...
        <div class="form-group">
          <Switch v-model="task.is_completed" :true-value="1" :false-value="0"
            >Completed</Switch
          >
        </div>
                  ...
                  <p class="file-name">
                    {{
                      task.attachment
                        ...
                        : task.file_name || "Current Attachment"
                    }}
                  </p>
                  <p class="file-hint">
                    {{
...
async function onSubmit() {
  try {
    ...
    if (successResult) {
      ...
      error("Failed to update task. Please try again.", "Error", {
        duration: 5000,
      });
    }
  } catch (err) {
    console.log(err);
    error("An unexpected error occurred while updating the task.", "Error", {
      duration: 5000,
    });
  }
}
